...
```
  We can see that there is dramatic difference between people whose ethnicity is and other races.
  
2. Are there any conclusions you can draw?
  Yes. People whose ethnicity is white have higher probability of death.
  
3. What were you not able to do due to not having the R knowledge?
  I will not be able to easily pull out all of the data and modify them into graphs, especially not with Excel.

4. What other data would be useful to better understand this data?
  Age would be a good variable to add if pausible because it has high relevancy with death.
